...
<form role="form" method="post" autocomplete="off" action="register_ok" enctype="multipart/form-data">
...
<div class="form-group1">
 ...
 <textarea rows="5" cols="100" id="gdsDes" name="gdsDes" class="form-control"></textarea>
<script> 
 var ckeditor_config = {
   resize_enaleb : false,
