...
<title>MK::<decorator:title /></title>
		...
		<nav class="navbar navbar-inverse">
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="/shop/main">MK-Mall</a>
				</div>
				<div class="collapse navbar-collapse" id="myNavbar">
					<ul class="nav navbar-nav">
						<c:if test="${param.ch != null}">
						<li><a href="/admin/goods/register?index&ch=1">상품 등록</a></li>
						<li><a href="/admin/goods/list?ch=1">상품 목록</a></li>
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<c:if test="${userName==null}">
							<li><a href="/shop/signup"><span
									class="glyphicon glyphicon-user"></span> 회원가입</a></li>
							<li><a href="/shop/login"><span
									class="glyphicon glyphicon-log-in"></span> Login</a></li>
						</c:if>
						<!-- 로그인은 한 경우의 메뉴 -->
						<c:if test="${userName != null }">
						<c:if test="${verify==9}">
							<li><a href="/admin/index?ch=1">관리자 화면</a></li>
						</c:if>
							<li id="welcome">${userName}</li>
							<li><a href="/member/view.do"> 내 정보 보기</a></li>
							<li><a href="/shop/logout"><span
