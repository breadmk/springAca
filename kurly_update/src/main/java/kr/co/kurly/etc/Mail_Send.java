...
public class Mail_Send 
{
	...
	public int setEmail(String email, String subject, String body) throws Exception 
	{
	     ...
	     final String username = "01191401058"; // 송신자 네이버 아이디
	     final String password = "fhaksths*1"; // 송신자 네이버 비밀번호  
	     int port=465;
	     int state=0;
	     ...
	     mimeMessage.setFrom(new InternetAddress("01191401058@naver.com")); // 송신자 네이버 주소
